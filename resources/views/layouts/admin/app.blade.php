...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand fixed-top" style="background: #212121">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar elevation-4" style="background:#212121">
            <!-- Brand Logo -->
            <a href="#" class="brand-link text-center">
                <img src="/assets/img/logomuseum.png" alt="Logo" style="max-width: 75px; height: auto;
