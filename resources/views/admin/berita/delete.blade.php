...
<a role="button" class="btn btn-sm btn-danger delete-button" data-bs-toggle="modal"
   data-bs-target="#modalHapusBerita{{ $item->id }}">
    <i class="fas fa-trash"></i> Hapus
</a>

<!-- Modal Hapus Berita -->
<div class="modal fade" id="modalHapusBerita{{ $item->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Hapus Berita</strong></h5>
